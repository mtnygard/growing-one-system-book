...
{aside} "What is architecture?" A question for the ages! Ruth Malan has a [great
...
|============|============|============|============|
| Perf-1     | Performance | GUI Response Time | When online, a user can enter a
single fact via the GUI in under one second. | | Sec-1      | Security   |
Confidentiality | Under all circumstances, no output shall include facts from
more than one World. |
|------------|------------|------------|------------|
